...
typedef enum {
  QLOG_OPTIMIZE_SHRINK_INIT,
  QLOG_OPTIMIZE_SHRINK,
  QLOG_OPTIMIZE_SHRINK_EXPAND,
  QLOG_OPTIMIZE_SHRINK_DONE,
  QLOG_OPTIMIZE_SHRINK_ERROR
} qlog_optimize_shrink_sm;
...
typedef struct qlog_trigger_optimize_sub_def {
  ...
  qlog_optimize_shrink_sm (*qlog_trigger_optimize_sub_trigger)(struct qlog_trigger_optimize_sub_def*); // ptr to function to append/determine 
  ...
  uint16_t qlog_trigger_optimize_sub_can_expand : 1;                  // determinant if optimize_sub type can expand
} qlog_trigger_optimize_sub_def;

typedef bool (*qlog_trigger_optimize_sub_trigger)(struct qlog_trigger_optimize_sub_def*);
typedef qlog_optimize_shrink_sm (*qlog_trigger_optimize_sub_shrink)(struct qlog_trigger_optimize_sub_def*);
 
struct qlog_trigger_optimize_sub_def* qlog_trigger_optimize_sub_init_base(
                                         qlog_trigger_optimize_sub_trigger trigger_shrink_func,
