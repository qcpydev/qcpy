...
#define QLOG_OPTIMIZE_EXPAND_MULTI_GATE \
  X(qlog_optimize_expand_controlled) \
...
void qlog_optimize_expand_controlled(struct qlog_def* qlog, struct qlog_def* optimized_qlog, qlog_optimize_def* qlog_optimize);
